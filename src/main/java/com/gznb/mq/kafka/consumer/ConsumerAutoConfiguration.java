package com.gznb.mq.kafka.consumer;

import com.gznb.mq.kafka.config.ConsumerProperties;
import com.gznb.mq.kafka.constants.KafkaConsumerConstants;
 ...
 */
@Configuration
@ConditionalOnProperty(name = {"gznb.mq.kafka.consumer.servers"},matchIfMissing = false)
