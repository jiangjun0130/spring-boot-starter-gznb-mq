package com.gznb.mq.kafka.producer;

import com.gznb.mq.kafka.config.ProducerProperties;
import com.gznb.mq.kafka.constants.KafkaProducerConstants;
...
@ConditionalOnProperty(name = "gznb.mq.kafka.producer.servers",matchIfMissing = false)
